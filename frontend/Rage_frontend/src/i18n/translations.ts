...
export const translations = {
  es: {
    ...
    // Charts (Dashboard Visual)
    chartAIvsHuman: 'IA vs Escalamiento Humano',
    chartCacheTitle: 'Eficiencia de Caché',
    chartIntentsTitle: 'Intenciones Más Consultadas',
    hitRate: 'Tasa de Acierto',
    savingsUsd: 'Ahorro USD',
    savingsCop: 'Ahorro COP',
    cacheMisses: 'Fallos de Caché',
    intentsEmpty: 'Sin datos de intenciones todavía.',

    // Historial & Bandeja de Tickets
    historyBtn: 'Historial',
    historyTitle: 'Historial & Bandeja de Tickets',
    historySubtitle: 'Conversaciones persistentes y cola de escalamiento humano',
    tabHistory: 'Historial',
    tabTickets: 'Bandeja de Tickets',
    noSessions: 'Sin conversaciones registradas todavía. Envía un mensaje para comenzar a persistir.',
    noTickets: 'No hay tickets de escalamiento pendientes.',
    sessionChannel: 'Canal',
    sessionMessages: 'Mensajes',
    sessionEscalations: 'Escalados',
    openTranscript: 'Transcripción de la Sesión',
    backToSessions: 'Volver',
    emptyTranscript: 'La sesión no contiene mensajes.',
    ticketIntent: 'Intención',
    ticketReason: 'Motivo de contacto',
    ticketStatus: 'Estado',
  ...
  en: {
    ...
    chartAIvsHuman: 'AI vs Human Escalation',
    chartCacheTitle: 'Cache Efficiency',
    chartIntentsTitle: 'Most Consulted Intents',
    hitRate: 'Hit Rate',
    savingsUsd: 'Savings USD',
    savingsCop: 'Savings COP',
    cacheMisses: 'Cache Misses',
    intentsEmpty: 'No intent data yet.',

    // History & Ticket Queue
    historyBtn: 'History',
    historyTitle: 'History & Ticket Queue',
    historySubtitle: 'Persistent conversations and human escalation queue',
    tabHistory: 'History',
    tabTickets: 'Ticket Queue',
    noSessions: 'No conversations recorded yet. Send a message to start persisting.',
    noTickets: 'No pending escalation tickets.',
    sessionChannel: 'Channel',
    sessionMessages: 'Messages',
    sessionEscalations: 'Escalated',
    openTranscript: 'Session Transcript',
    backToSessions: 'Back',
    emptyTranscript: 'The session contains no messages.',
    ticketIntent: 'Intent',
    ticketReason: 'Contact reason',
    ticketStatus: 'Status',
